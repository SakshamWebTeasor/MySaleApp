...
const Home = () => {
  ...
  function renderFeaturedItems(item, index) {
    return (
      ...
      >
        <Text
          style={
            { color: COLORS.lightGray, ...FONTS.h5 } as StyleProp<TextStyle>
          }
        >
          {item.type}
        </Text>
        ...
        >
          <View style={style.featuredDetails}>
            ...
            <Text
              style={
                { color: COLORS.white, ...FONTS.h2 } as StyleProp<TextStyle>
              }
            >
              {item.price}
            </Text>
  ...
  function renderRecentSearches(item, index) {
    return (
      ...
      >
        ...
        >
          <Text>{item.name}</Text>
          <Text style={{ ...FONTS.h3 } as StyleProp<TextStyle>}>
            {item.price}
          </Text>
        </View>
      </TouchableOpacity>
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity
        style={{
          marginLeft: "auto", // Pushes the toggle button to the right
        }}
        onPress={toggleTheme}
      >
        <Icon
